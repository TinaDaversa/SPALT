...
class Node:
    ...
    def __init__(self, id=None, threshold=[],
                 ...
                 loss=None, model=None, classes=None, samples_id=[]):
        self.id = id
...
class _LinearTree(BaseEstimator):
    ...
    def plot_model(self, feature_names=None, max_depth=None, IPython=None):
